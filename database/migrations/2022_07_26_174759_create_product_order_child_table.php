...
class CreateProductOrderChildTable extends Migration
{
    /**
     * Run the migrations.
     *
...
CREATE TABLE `lied_product_order_child` (
  ...
  `show_status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '展示状态',
  ...
  CONSTRAINT `product_order_child-product_order_id` FOREIGN KEY (`product_order_id`) REFERENCES `lied_product_order` (`id`) ON UPDATE CASCADE
    ...
    {
        Schema::dropIfExists('product_order_child');
    }
}
