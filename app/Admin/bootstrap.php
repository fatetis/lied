...
Admin::css('vendor/laravel-admin-ext/lightbox/lightbox/lightbox.min.css');//lightbox2 灯箱
Admin::js('vendor/laravel-admin-ext/lightbox/lightbox/lightbox.min.js');//lightbox2 灯箱
